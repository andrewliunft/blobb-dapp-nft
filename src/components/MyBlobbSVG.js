...
function MyBlobbSVG({ currAccount, blobb, show, setShow }) {
  ...
  const SVG_BLOBB = () => 
    <svg className={show ? classes.blobb_svg_w_stats : classes.blobb_svg } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" fill="none">
      ...
      <g style={{opacity: Number(blobb.creator === blobb.owner)}}>
      ...
      <defs>
        ...
        />
        <linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style={{stopColor: "rgb("+blobb.colors.start+","+blobb.hp/10+")", stopopacity: 0.5}} />
          <stop offset="100%" style={{stopColor: "rgb("+blobb.colors.end+","+blobb.hp/10+")", stopopacity: 0.5}} />
        </linearGradient>
        <linearGradient id="s-grad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style={{stopColor: "rgb("+blobb.colors.start+")", stopopacity: 0.5}} />
          <stop offset="100%" style={{stopColor: "rgb("+blobb.colors.end+")", stopopacity: 0.5}} />
        </linearGradient>
